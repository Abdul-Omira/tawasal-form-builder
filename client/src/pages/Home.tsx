        ...
        >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              {/* Minister's Complete Message in One Box */}
              <motion.div 
                ...
                <div className="relative bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-md rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 border border-white/30 shadow-2xl">
                  ...
                  <div className="text-white/95 leading-relaxed text-right">
                    ...
                    <div className="text-base">
                      <p className="mb-3 text-white/80 italic">مع أطيب التمنيات،</p>
                      <p className="font-bold text-white mb-2">عبدالسلام هيكل</p>
                      <p className="text-white/90 font-medium">وزير الاتصالات وتقانة المعلومات</p>
                      <p className="text-white/80 mt-1">الجمهورية العربية السورية</p>
                    </div>
                  </div>
                </div>
              </motion.div>
